...
update wp_users set user_pass=MD5('qa') where id =1;

--Эмуляция запроса на запись
call dorepeat_v1(1);
call dorepeat_v2(1, 'text');

--эмуляция запроса на чтение
SELECT * from wp_comments wc 
order by comment_ID desc;

--сколько комитов записали в бд
